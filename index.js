...
// call the function so all games appear on the page
...
const descriptionText = `A total of ${unfundedGamesCount} game${unfundedGamesCount === 1 ? "" : "s"} remain${unfundedGamesCount === 1 ? "s" : ""} unfunded.`;
